...
cart_router.get("/:cid", authLogin, cartController.getByIdPopulate)

cart_router.post("/:cid/products/:pid", authLogin, isCart, cartController.addCartProduct)

cart_router.delete("/:cid/products/:pid",authLogin, isCart, cartController.deleteCartProduct) 

cart_router.put("/:cid", cartController.updateCart)

cart_router.put("/:cid/products/:pid",authLogin, isCart, cartController.updateCartProduct)
